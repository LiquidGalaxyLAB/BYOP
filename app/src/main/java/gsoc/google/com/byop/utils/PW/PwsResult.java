...
public class PwsResult implements Comparable<PwsResult> {
    ...
    public static class Builder {
         ...
         */
        public Builder(PwsResult pwsResult) throws JSONException {
         ...
         * @return the Builder object for chaining operations.
         */
        public Builder addExtra(String key, int value) throws JSONException {
            mNewExtraData.put(key, value);
            return this;
        }
         ...
         * @return the Builder object for chaining operations.
         */
        public Builder addExtra(String key, long value) throws JSONException {
            mNewExtraData.put(key, value);
            return this;
        }
